...
public class ManUnitedGUI extends JFrame {

    public static int money = 300000;

    public ManUnitedGUI(Player player){
        ...
        JLabel title = new JLabel("Welcome to the Manchester United team");
        ...
        JLabel manUnitedShirt = new JLabel(new ImageIcon("man_united_shirt.jpg"));
        ...
        store.addActionListener(a->new ManUnitedStoreGUI());
        ...
        displayTeam.addActionListener(a->new DisplayManUnitedTeamGUI());
        // setting the frame
